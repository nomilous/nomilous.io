...
module.exports = function(id, hostname, port) {
  ...
  return Promise.all(['/earth', '/visitors'].map(function(path) {
    ...
    var animate, bokehPass, city, composer, country, earth, geometry, landMasses, ll, material, me, particles, polygon, region, renderModel, vertex, visitors, _i, _j, _k, _len, _len1, _len2, _ref;
