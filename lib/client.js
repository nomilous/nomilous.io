...
module.exports = function(id, hostname, port) {
  ...
  return Promise.all(['/earth', '/visitors'].map(function(path) {
    ...
    var animate, bluriness, city, composer, country, earth, geometry, hblur, landMasses, lastPass, ll, material, me, particles, polygon, region, renderModel, renderTarget, vblur, vertex, visitors, _i, _j, _k, _len, _len1, _len2, _ref;
