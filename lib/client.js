...
module.exports = function(id, hostname, port) {
  ...
  var Promise, THREE, aspect, bluriness, camera, canvas, container, dom, far, fov, height, near, radianRatio, radius, renderer, rotationX, rotationY, scene, toLatitude, toLongitude, transform, width, xhr;
  dom = require('dom');
  THREE = require('three-webgl-renderer');
  require('three-camera', require('three-scene'));
  xhr = require('xhr');
  ...
  return Promise.all(['/earth', '/visitors'].map(function(path) {
    ...
    var animate, city, country, earth, elem, geometry, i, labelGeom, labelLine, labelMat, landMasses, ll, material, me, particles, persons, polygon, position, projector, region, text, updateLocation, vertex, visitors, _i, _j, _k, _len, _len1, _len2, _ref;
