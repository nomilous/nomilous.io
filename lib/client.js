...
module.exports = function(id, hostname, port) {
  ...
  var Promise, THREE, aspect, bluriness, camera, canvas, client, container, dom, far, fov, height, near, radianRatio, radius, renderer, scene, toLatitude, toLongitude, transform, width, xhr;
  dom = require('dom');
  THREE = require('three');
  ...
  return Promise.all(['/earth', '/visitors'].map(function(path) {
    ...
    var animate, city, composer, country, earth, geometry, hblur, i, landMasses, lastPass, ll, material, me, particles, polygon, region, renderModel, renderTarget, vblur, vertex, visitors, _i, _j, _k, _len, _len1, _len2, _ref;
