...
module.exports = function(id, hostname, port) {
  ...
  var Promise, THREE, aspect, bluriness, canvas, client, container, dom, fov, height, nearCam, radianRatio, radius, renderer, scene, toLatitude, toLongitude, transform, width, xhr;
  dom = require('dom');
  THREE = require('three');
