...
module.exports = function(id, hostname, port) {
  ...
  return Promise.all(['/earth', '/visitors'].map(function(path) {
    ...
    var animate, city, composer, country, earth, geometry, i, labelGeom, labelLine, labelMat, landMasses, lastPass, ll, material, me, particles, person, persons, polygon, position, region, renderModel, vertex, visitors, _i, _j, _k, _len, _len1, _len2, _ref;
    ...
    animate = function() {
      ...
      for (_m = 0, _len4 = persons.length; _m < _len4; _m++) {
        ...
        _results.push(person.line.rotation.y += rotationY);
      }
      return _results;
    };
