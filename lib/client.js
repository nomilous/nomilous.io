...
module.exports = function(id, hostname, port) {
  ...
  return Promise.all(['/earth', '/visitors'].map(function(path) {
    ...
    var animate, city, composer, country, earth, geometry, i, kaleido, landMasses, lastPass, ll, material, me, particles, polygon, region, renderModel, vertex, visitors, _i, _j, _k, _len, _len1, _len2, _ref;
